...
#meta(
  title: [计图入门之FreeGLUT (1)],
  date: datetime(year: 2025, month: 10, day: 4, hour: 22, minute: 3, second: 0),
...
比如, 一个三维向量可以是 $chevron.l X, Y, Z chevron.r$, 而作为等式中的一部分时,
可以是
$ arrow(a) = vec(x, y, z) $
...
一般写于括号中 $chevron.l X, Y, Z chevron.r$.
